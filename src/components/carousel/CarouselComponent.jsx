                ...
                <div className="item-image">
                    <NavLink to={'/'}>
                        <picture>
                            ...
                            <img src="https://i.ibb.co/86R0gHh/elden-ring-carousel.jpg" alt="" />
                        </picture>
                    </NavLink>
                </div>
            ...
            <div className="carousel-item" id="2">
                ...
                <div className="item-image">
                    <picture>
                        ...
                        <img src="https://i.ibb.co/YjQ8SGY/ea-fc-24-carousel.jpg" alt="" />
                    </picture>
                </div>
                <div className="item-text">
                    <h1 className="item-title">EA FC 24</h1>
            ...
            <div className="carousel-item" id="3">
                ...
                <div className="item-image">
                    <picture>
                        ...
                        <img src="https://i.ibb.co/RHHYXnJ/Diablo-IV-carousel.png" alt="" />
                    </picture>
                </div>
                <div className="item-text">
            ...
            <div className="carousel-item" id="4">
                ...
                <div className="item-image">
                    <picture>
                        ...
                        <img src="https://i.ibb.co/D5HdKzX/hogwarts-legacy-carousel.jpg" alt="" />
                    </picture>
                </div>
                <div className="item-text">

...
export default function Register() {
    ...
    return (
        <main className="main-container">
            <form className="register-form" onSubmit={(e) => addUser(HandleSubmit(e))}>
                ...
                <div className="inputs-container">
                    ...
                    <div className="input-group">
                        ...
                        <input type="password" className="form-input" name="userPassword" id="userPassword" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,30}$" />
                    </div>
                    <div className="input-group">
                        <label className="input-title" htmlFor="userPasswordConfirmation">Repetir Contraseña: *</label>
                        <input type="password" className="form-input" name="userPasswordConfirmation" id="userPasswordConfirmation" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,30}$" />
                    </div>
                    <div className="input-group">
